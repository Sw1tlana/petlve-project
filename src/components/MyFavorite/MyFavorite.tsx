    ...
    <section className={favoriteStyle.sectionFavorite}>
      ...
      {showViewed ? (
        viewedItems && viewedItems.length > 0 ? (
          ...
          <p className={favoriteStyle.descriptionFavorite}>
        ...
        <ul className={favoriteStyle.favoriteList}>
          {favoritePets
            .filter(
              (noticeItem): noticeItem is Pet =>
                !!noticeItem && !!noticeItem._id && !!noticeItem.imgURL
            )
              ...
              >
                ...
                <div className={favoriteStyle.containerInfo}>
                  <p className={favoriteStyle.description}>
                    <span className={favoriteStyle.spanDescription}>Name: </span>
                    {noticeItem.name}
                  </p>
                  <p className={favoriteStyle.description}>
        ...
        <p className={favoriteStyle.descriptionFavorite}>
          Oops,
          <span className={favoriteStyle.textSpan}>
            {" "}
          ...
          <span className={favoriteStyle.notifySpan}>🐾</span>
        </p>
      )}
    </section>
  )};
